...
const IntroSection = () => {
  return (
    <section id="intro" className="min-h-screen flex items-center justify-center pt-16 pb-24 px-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <motion.div 
              className="absolute -bottom-12 -right-12 w-40 h-40 bg-blue-500/10 dark:bg-blue-500/20 rounded-full"
              animate={{ 
                scale: [1, 1.2, 1],
                rotate: [0, 90, 0], 
              }}
            ...
            />
            <motion.div 
              className="absolute -top-12 -left-12 w-24 h-24 bg-purple-500/10 dark:bg-purple-500/20 rounded-full"
              animate={{ 
                scale: [1, 1.3, 1],
                rotate: [0, -90, 0], 
              }}
